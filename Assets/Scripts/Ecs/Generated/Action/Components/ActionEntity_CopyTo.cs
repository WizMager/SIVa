...
public partial class ActionEntity
{
	...
	public void CopyComponentTo(IComponent component)
	{
		...
		if (component is Assets.Scripts.Ecs.Action.Components.ParametersComponent Parameters)
		{
			CopyParametersTo(Parameters);
		}
		...
		else if (component is ActionDestroyedAddedListenerComponent ActionDestroyedAddedListener)
		{
			CopyActionDestroyedAddedListenerTo(ActionDestroyedAddedListener);
		}
		#endif
	}
	...
	/// </summary>
	public void CopyTo(ActionEntity copyToEntity)
	{
		for (var i = 0; i < ActionComponentsLookup.TotalComponents; ++i)
		{
			if (HasComponent(i))
			{
				if (copyToEntity.HasComponent(i))
				{
					throw new EntityAlreadyHasComponentException(
						...
						ActionComponentsLookup.ComponentNames[i] +
						"' to " +
						this +
						"!",
	...
	/// </summary>
	public void CopyTo(ActionEntity copyToEntity, bool replaceExisting)
	{
		for (var i = 0; i < ActionComponentsLookup.TotalComponents; ++i)
		{
			if (!HasComponent(i))
	...
	/// <summary>
	/// Copies components on this entity at <paramref name="indices"/> in the <see cref="ActionComponentsLookup"/> to
	...
	/// </summary>
	public void CopyTo(ActionEntity copyToEntity, bool replaceExisting, params int[] indices)
	{
		for (var i = 0; i < indices.Length; ++i)
		{
			...
			if (index < 0 && index >= ActionComponentsLookup.TotalComponents)
			{
				...
				throw new IndexOutOfLookupRangeException(
					string.Format(OUT_OF_RANGE_WARNING, index, nameof(ActionComponentsLookup)),
					HINT);
			}
